...
## Service microservice Explained
...
3.) How we integrate into the dealership


---------------------- Technicians - The heart of what we do here at CarCar (We are considering renaming, don't worry) ----------------------
...
LIST TECHNICIAN - Following this endpoint will give you a list of all technicians that are currently employed.
...
This how our technician detail is display. If you want to change the technician, just change the value at the end to match the "id" of the technician you want to display.
...
How this all starts it as our inventory stage. We have a list of automobiles on our lot that are available to buy.
...
We use a sophisticated poller to automatically update the inventory on the lot. This way, our service team and sales team keep track of all vehicles, seamlessly. -->
...
# SALES: Accessing Endpoints to Send and View Data: Access through Insomnia
